...
#import "ZJStarRateView.h"

#define FOREGROUND_STAR_IMAGE_NAME @"zj_star_above"
#define BACKGROUND_STAR_IMAGE_NAME @"zj_star_background"
#define DEFALUT_STAR_NUMBER 5
#define ANIMATION_TIME_INTERVAL 0.2

@interface ZJStarRateView ()
...
- (void)layoutSubviews {
    ...
    __weak ZJStarRateView *weakSelf = self;
